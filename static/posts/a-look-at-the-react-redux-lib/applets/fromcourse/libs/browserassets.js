...
/***/ function(module, exports, __webpack_require__) {
	...
	window.ReactDOM = __webpack_require__(170);
	window.Redux = __webpack_require__(171);
	window.ReactRedux = __webpack_require__(181);
	window.ReactRouter = __webpack_require__(189);
	window.ReduxThunk = __webpack_require__(245).default;

	console.log("VERSION",__webpack_require__(1).version)
	...
	function precacheChildNodes(inst, node) {
	  ...
	  outer: for (var name in children) {
	    ...
	    // We reached the end of the DOM children without finding an ID match.
	     true ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Unable to find element with ID %s.', childID) : invariant(false) : undefined;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function findDOMNode(componentOrElement) {
	  ...
	  if (typeof componentOrElement.render === 'function') {
	     true ? process.env.NODE_ENV !== 'production' ? invariant(false, 'findDOMNode was called on an unmounted component.') : invariant(false) : undefined;
	  } else {
